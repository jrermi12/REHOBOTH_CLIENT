      ...
      <div class="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center">
          ...
          <p class="mt-5 text-xl text-gray-500 sm:text-center">
            Find the route that fits your location, your budget, and your needs.
            With our ride service, you can get to and from school easily, no
                            ...
                            >
                              ...
                              <div class="flex flex-col my-4">
                                ...
                                <textarea
                                  ...
                                  name="medical"
                                  v-model="medical"
                                  placeholder="write a brief description if there are any medical issue "
                                  class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900"
                                />
                              </div>
...
export default {
  ...
  methods: {
    ...
    registerCustomer() {
      ...
      formData.append("FphoneNumber", this.FphoneNumber);
      formData.append("MphoneNumber", this.MphoneNumber);
      formData.append("studentAge", this.studentAge);
      formData.append("studentGrade", this.studentGrade);
      formData.append("studentGender", this.studentGender);
      formData.append("startingPoint", this.startingPoint);
      formData.append("medical", this.medical);
      formData.append("studentAge", this.studentAge);

      store.dispatch("Customer/create", formData);
    },
  },
